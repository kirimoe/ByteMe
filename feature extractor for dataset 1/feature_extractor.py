...
def extract_pe_features(file_path):
    ...
    'Type': pe.FILE_HEADER.Characteristics,
    'SizeOfStackReserve': pe.OPTIONAL_HEADER.SizeOfStackReserve,
    'edata_PointerToLinenumbers': pe.sections[4].PointerToLinenumbers if len(pe.sections) > 4 else None,
    'rdata_PointerToRelocations': pe.sections[0].PointerToRelocations if len(pe.sections) > 0 else None,
    'tls_PointerToRelocations': pe.sections[8].PointerToRelocations if len(pe.sections) > 8 else None,
    'MajorSubsystemVersion': pe.OPTIONAL_HEADER.MajorSubsystemVersion,
    'e_ovno': pe.DOS_HEADER.e_ovno,
    'idata_PointerToRawData': pe.sections[1].PointerToRawData if len(pe.sections) > 1 else None,
    'tls_PointerToLinenumbers': pe.sections[8].PointerToLinenumbers if len(pe.sections) > 8 else None,
    'e_cp': pe.DOS_HEADER.e_cp,
    'idata_Misc_VirtualSize': pe.sections[1].Misc_VirtualSize if len(pe.sections) > 1 else None,
    'e_ss': pe.DOS_HEADER.e_ss,
    'rsrc_NumberOfRelocations': pe.sections[6].NumberOfRelocations if len(pe.sections) > 6 else None,
    'rsrc_PointerToRelocations': pe.sections[6].PointerToRelocations if len(pe.sections) > 6 else None,
    'NumberOfSymbols': pe.FILE_HEADER.NumberOfSymbols,
    'idata_NumberOfRelocations': pe.sections[1].NumberOfRelocations if len(pe.sections) > 1 else None,
    'e_lfarlc': pe.DOS_HEADER.e_lfarlc,
    'text_VirtualAddress': pe.sections[5].VirtualAddress if len(pe.sections) > 5 else None,
    'text_Misc_VirtualSize': pe.sections[5].Misc_VirtualSize if len(pe.sections) > 5 else None,
    'tls_NumberOfRelocations': pe.sections[8].NumberOfRelocations if len(pe.sections) > 8 else None,
    'SectionAlignment': pe.OPTIONAL_HEADER.SectionAlignment,
    'edata_PointerToRelocations': pe.sections[4].PointerToRelocations if len(pe.sections) > 4 else None,
    'Reserved1': pe.FILE_HEADER.Reserved1 if hasattr(pe.FILE_HEADER, 'Reserved1') else None,
    'rsrc_NumberOfLinenumbers': pe.sections[6].NumberOfLinenumbers if len(pe.sections) > 6 else None,
    'FileAlignment': pe.OPTIONAL_HEADER.FileAlignment,
    'reloc_NumberOfLinenumbers': pe.sections[7].NumberOfLinenumbers if len(pe.sections) > 7 else None,
    'pdata_Characteristics': pe.sections[2].Characteristics if len(pe.sections) > 2 else None,
    'edata_NumberOfRelocations': pe.sections[4].NumberOfRelocations if len(pe.sections) > 4 else None,
    'pdata_PointerToRelocations': pe.sections[2].PointerToRelocations if len(pe.sections) > 2 else None,
    'pdata_NumberOfLinenumbers': pe.sections[2].NumberOfLinenumbers if len(pe.sections) > 2 else None,
    'idata_NumberOfLinenumbers': pe.sections[1].NumberOfLinenumbers if len(pe.sections) > 1 else None,
    'MinorLinkerVersion': pe.OPTIONAL_HEADER.MinorLinkerVersion,
    'rdata_VirtualAddress': pe.sections[0].VirtualAddress if len(pe.sections) > 0 else None,
    'edata_SizeOfRawData': pe.sections[4].SizeOfRawData if len(pe.sections) > 4 else None,
    'bss_VirtualAddress': pe.sections[9].VirtualAddress if len(pe.sections) > 9 else None,
    'SizeOfCode': pe.OPTIONAL_HEADER.SizeOfCode,
    'data_VirtualAddress': pe.sections[3].VirtualAddress if len(pe.sections) > 3 else None,
    'e_cparhdr': pe.DOS_HEADER.e_cparhdr,
    'tls_PointerToRawData': pe.sections[8].PointerToRawData if len(pe.sections) > 8 else None,
    'rsrc_SizeOfRawData': pe.sections[6].SizeOfRawData if len(pe.sections) > 6 else None,
    'data_PointerToRawData': pe.sections[3].PointerToRawData if len(pe.sections) > 3 else None,
    'text_NumberOfRelocations': pe.sections[5].NumberOfRelocations if len(pe.sections) > 5 else None,
    'Characteristics': pe.FILE_HEADER.Characteristics,
    'rdata_Characteristics': pe.sections[0].Characteristics if len(pe.sections) > 0 else None,
